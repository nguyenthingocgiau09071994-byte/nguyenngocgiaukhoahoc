...
const courses={
business:{name:"Masterclass: Chuyên Gia Xây Kênh & Chuyển Đổi Đa Nền Tảng",subtitle:"Hành trình 28 ngày kiến tạo thương hiệu và bứt phá doanh thu qua Video",desc:"Chương trình đào tạo thực chiến đỉnh cao được thiết kế chuyên biệt để giúp bạn làm chủ nghệ thuật Storytelling, kỹ thuật biên tập CapCut chuyên nghiệp, và chiến lược tối ưu thuật toán để thống lĩnh TikTok, Facebook Reels và YouTube Shorts.",students:"2.850+",rating:"4.9",hours:"9 giờ",level:"28 bài thực chiến",icon:"▶",image:"assets/slide-user-1.png"},
growth:{name:"Masterclass: Đánh Thức Trí Tuệ & Nâng Tầm Phong Cách Sống",subtitle:"Tái thiết tư duy tinh hoa, kỷ luật thép và nghệ thuật giao tiếp đỉnh cao",desc:"Lộ trình phát triển toàn diện giúp bạn bứt phá giới hạn, tái lập tư duy xuất chúng và làm chủ nghệ thuật giao tiếp. Dành riêng cho những cá nhân khao khát nâng tầm vị thế, gia tăng sức ảnh hưởng và kiến tạo cuộc sống thịnh vượng.",students:"1.920+",rating:"4.8",hours:"10 giờ",level:"Mọi trình độ",icon:"✦",image:"assets/slide-growth.png"}};
const modules=[
{id:"bch1",cat:"business",title:"Module 1: Giải Phóng Trọng Lực Ống Kính",summary:"Phá vỡ rào cản tâm lý, định hình phong thái tự tin và kỹ thuật mở đầu thôi miên",progress:0,open:true,lessons:[["b1","Vượt qua rào cản sợ quay video lên hình","14:30"],["b2","Bố cục quay video như thế nào","16:20"],["b3","Cách đứng nói chuyện tự tin trước camera","18:10"],["b4","3 lỗi khiến video của bạn trông bị giả","12:45"],["b5","Cách đặt câu hook mở đầu video","15:30"],["b6","Liệt kê vấn đề khách hàng đang gặp phải","17:15"],["b7","Cách tự tin nói chuyện trước camera","19:00"]]},
{id:"bch2",cat:"business",title:"Module 2: Điện Ảnh Hóa Khung Hình",summary:"Kỹ thuật thiết lập ánh sáng, làm chủ góc máy và tiêu chuẩn quay dựng chuyên nghiệp",progress:0,lessons:[["b8","Cách quay video đúng và dễ áp dụng","16:40"],["b9","Cách quay video ghép short","18:25"],["b10","Quay video ánh sáng đẹp, rõ và sắc nét","21:10"],["b11","Setup góc quay video thế nào là đúng","20:35"],["b12","Làm quen phần mềm edit video CapCut","24:00"]]},
{id:"bch3",cat:"business",title:"Module 3: Hậu Kỳ Cấp Độ Chuyên Gia",summary:"Tuyệt kỹ CapCut: Phối hợp âm thanh, hiệu ứng thị giác và nghệ thuật giữ chân khán giả",progress:0,lessons:[["b13","Cách lồng tiếng video","17:20"],["b14","Chỉnh video sáng rõ đẹp thu hút người xem","22:10"],["b15","Đặt tiêu đề, phụ đề chuyên nghiệp","19:30"],["b16","Thêm hiệu ứng âm thanh vào video","16:50"],["b17","Chỉnh thông số CapCut cho video rõ nét","18:40"]]},
{id:"bch4",cat:"business",title:"Module 4: Nghệ Thuật Điểu Khiển Đám Đông",summary:"Thiết kế kịch bản triệu view, ứng biến linh hoạt và duy trì năng lượng đỉnh cao",progress:0,lessons:[["b18","Hãy hoạt ngôn khi quay video","15:45"],["b19","Cách lấy năng lượng để quay video","14:20"],["b20","Quay video để không bị bí ý tưởng","20:10"],["b21","Làm video bán hàng hay video triệu view","18:30"],["b22","Một ngày nên đăng bao nhiêu clip","13:50"],["b23","Xây thương hiệu cá nhân hay bán hàng luôn","19:15"],["b24","Những lỗi phổ biến khi xây kênh","17:40"]]},
{id:"bch5",cat:"business",title:"Module 5: Kỷ Nguyên Tăng Trưởng & Bứt Phá",summary:"Chiến lược phân phối nội dung, tối ưu thuật toán và bản đồ thực thi 28 ngày",progress:0,lessons:[["b25","Nên làm gì khi bí ý tưởng quay","16:10"],["b26","Khi nào chạy quảng cáo cho video","18:55"],["b27","Quay video nhanh, hiệu quả, tiết kiệm thời gian","21:20"],["b28","Kết thúc 28 ngày làm video cho người mới","23:00"]]},
{id:"gch1",cat:"growth",title:"Module 1: Tái Thiết Tư Duy Xuất Chúng",summary:"Định vị lại bản ngã, phá vỡ niềm tin giới hạn và thiết lập mục tiêu chiến lược",progress:60,open:true,lessons:[["g1","Khám phá giá trị và thế mạnh bản thân","21:20",1],["g2","Thiết lập mục tiêu SMART","18:35"],["g3","Vượt qua niềm tin giới hạn","20:10"]]},
{id:"gch2",cat:"growth",title:"Module 2: Quản Trị Hiệu Suất Tối Đa",summary:"Kiến tạo kỷ luật thép, làm chủ năng lượng và tối ưu hóa thời gian làm việc sâu",progress:25,lessons:[["g4","Kỷ luật cá nhân trong 30 ngày","17:15"],["g5","Quản trị thời gian và năng lượng","24:40"],["g6","Duy trì sự tập trung sâu","19:25"]]},
{id:"gch3",cat:"growth",title:"Module 3: Quyền Năng Của Ngôn Từ",summary:"Làm chủ nghệ thuật giao tiếp thấu cảm, xử lý mâu thuẫn và kiến tạo sức ảnh hưởng",progress:0,lessons:[["g7","Kỹ năng lắng nghe chủ động","18:20"],["g8","Giao tiếp thuyết phục","22:45"],["g9","Xử lý mâu thuẫn tích cực","20:30"]]},
];
...
function courseIntro(){const c=courses[active];const pct=active==="business"?"42%":"28%";const factCell=(icon,val,label)=>'<span style="flex:1 !important;display:flex !important;flex-direction:column !important;align-items:center !important;justify-content:center !important;text-align:center !important;padding:10px 4px !important;border:0 !important;min-height:66px !important;box-sizing:border-box !important"><i style="font-style:normal !important;font-size:13px !important;opacity:.85 !important;margin-bottom:4px !important;display:block !important;color:#ffd875 !important">'+icon+'</i><b style="font-size:15px !important;color:#ffffff !important;white-space:nowrap !important">'+val+'</b><small style="font-size:9px !important;color:#9ed5d1 !important;white-space:nowrap !important;margin-top:2px !important">'+label+'</small></span>';q("#courseIntro").innerHTML='<div class="courseCover '+active+'"><div class="courseImage" style="background-image:url('+c.image+')"><i>'+c.icon+'</i></div><div class="courseMain"><span class="commercialBadge">KHÓA HỌC NỔI BẬT</span><h2>'+c.name+'</h2><h3>'+c.subtitle+'</h3><p>'+c.desc+'</p><div class="courseFacts" style="display:flex !important;gap:6px !important;padding:4px !important">'+factCell("♥",c.students,"Học viên")+factCell("★",c.rating,"Đánh giá")+factCell("◷",c.hours,"Thời lượng")+factCell("▤",c.level,"Thực chiến")+'</div></div><div class="courseAction" style="display:flex !important;align-items:center !important;gap:14px !important;text-align:left !important">'+'<div style="width:44px;height:44px;border-radius:50%;flex-shrink:0;display:grid;place-items:center;background:conic-gradient(#ffd875 0 '+pct+', rgba(255,255,255,.18) 0)"><div style="width:34px;height:34px;border-radius:50%;background:#0d3f45;display:grid;place-items:center;color:#ffd875;font-size:10.5px;font-weight:800">'+pct+'</div></div>'+'<div style="flex:1;min-width:0"><small style="display:block;color:#9ed5d1;font-size:9px !important;letter-spacing:.02em !important">ĐÃ HOÀN THÀNH · TRUY CẬP TRỌN ĐỜI</small></div>'+'<button data-play="'+(active==="business"?"b1":"g1")+'" style="flex-shrink:0 !important;margin:0 !important">▶ Tiếp tục học</button></div></div>'}
function render(term=""){courseIntro();const data=modules.filter(m=>m.cat===active).map(m=>({...m,lessons:m.lessons.filter(l=>l[1].toLowerCase().includes(term.toLowerCase()))})).filter(m=>!term||m.lessons.length);q("#modules").innerHTML=data.map((m,mi)=>'<article class="module '+(m.open||term?"open":"")+'"><button class="chapterHead" style="background:linear-gradient(90deg,#105f68,#11727a) !important"><span class="chapterLabel">CHƯƠNG '+(mi+1)+'</span><span class="modTitle"><b style="color:#ffffff !important;text-transform:uppercase !important">'+m.title+'</b><small style="color:#d7efed !important">'+m.summary+'</small></span><span class="chapterMeta"><b style="color:#ffffff !important">'+m.lessons.length+' bài học</b><small style="color:#d7efed !important">'+m.progress+'% hoàn thành</small></span><span class="chev" style="color:#ffffff !important">⌄</span></button><div class="lessons">'+m.lessons.map((l,i)=>'<div class="lesson '+(l[4]?"current":"")+'"><div><span class="state '+(l[3]?"done":"")+'" style="background:'+(l[3]?"#16a34a":"#105f68")+' !important;border-color:'+(l[3]?"#16a34a":"#105f68")+' !important;color:#ffffff !important;font-weight:800 !important">'+(l[3]?"✓":String(i+1).padStart(2,"0"))+'</span><span class="lessonText"><small>BÀI TẬP '+(i+1)+'</small><b>'+l[1]+'</b><em>Video bài giảng · Có tài liệu đính kèm</em></span></div><span class="time"><b>◷ '+l[2]+'</b><small>phút</small></span><button data-play="'+l[0]+'">▶ Xem bài giảng</button></div>').join("")+'</div></article>').join("")||'<div class="empty">Không tìm thấy bài học.</div>';const vids=all.filter(l=>l.cat===active&&l.title.toLowerCase().includes(term.toLowerCase()));q("#videoGrid").innerHTML=vids.map((l,i)=>'<article class="videoCard"><button class="thumb" data-play="'+l.id+'"><span class="play">▶</span><span class="dur">'+l.time+'</span></button><div class="videoBody"><span class="tag">'+(l.cat==="business"?"Kinh doanh":"Phát triển bản thân")+'</span><h3>'+l.title+'</h3><footer><label>BÀI '+(i+1)+'</label><button data-play="'+l.id+'">Xem ngay →</button></footer></div></article>').join("")||'<div class="empty">Không tìm thấy video.</div>'}
...
document.addEventListener("click",e=>{const p=e.target.closest("[data-play]");if(p)return openVideo(p.dataset.play);const h=e.target.closest(".chapterHead");if(h)h.parentElement.classList.toggle("open");if(e.target.closest("[data-close]"))closeVideo()});qa(".tab").forEach(b=>b.onclick=()=>{active=b.dataset.cat;qa(".tab").forEach(x=>x.classList.toggle("active",x===b));render(q("#search").value);q("#curriculum").scrollIntoView({behavior:"smooth"})});q("#search").oninput=e=>render(e.target.value);q("#complete").onclick=()=>{if(current){current.done=1;toast("Đã hoàn thành: "+current.title);closeVideo();render(q("#search").value)}};document.addEventListener("keydown",e=>e.key==="Escape"&&closeVideo());const note=q("#note");note.value=localStorage.getItem("masterclass-note")||"";q("#save").onclick=()=>{localStorage.setItem("masterclass-note",note.value);q("#noteStatus").textContent="Đã lưu lúc "+new Date().toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"});toast("Đã lưu ghi chú")};q("#menu").onclick=()=>{if(window.innerWidth<=760){const side=q("#side");const isOpen=side.classList.toggle("open");q("#menu").setAttribute("aria-expanded",isOpen)}else{q(".app").classList.toggle("collapsed");localStorage.setItem("masterclass-sidebar",q(".app").classList.contains("collapsed"))}};if(localStorage.getItem("masterclass-sidebar")==="true"&&window.innerWidth>760){q(".app").classList.add("collapsed")}q("#closeSide").onclick=()=>{q("#side").classList.remove("open");q("#menu").setAttribute("aria-expanded","false")};qa("#side nav a").forEach(a=>a.onclick=()=>{qa("#side nav a").forEach(x=>x.classList.remove("active"));a.classList.add("active");q("#side").classList.remove("open");q("#menu").setAttribute("aria-expanded","false")});qa(".mobileTabBar a").forEach(a=>a.onclick=()=>{qa(".mobileTabBar a").forEach(x=>x.classList.remove("active"));a.classList.add("active")});q("#filter").onclick=()=>toast("Đang hiển thị tất cả bài giảng");render();
...
(()=>{const login=document.querySelector('#loginForm');if(!login||document.querySelector('#forgotPasswordButton'))return;const forgot=document.createElement('button');forgot.type='button';forgot.id='forgotPasswordButton';forgot.className='forgotPasswordButton';forgot.innerHTML='◇ Quên mật khẩu?';const primary=login.querySelector(':scope > .primary');primary?.before(forgot);const modal=document.createElement('div');modal.className='forgotModal';modal.id='forgotModal';modal.innerHTML='<div class="forgotShade" data-close-forgot></div><form class="forgotCard" id="forgotForm"><button type="button" class="forgotClose" data-close-forgot>×</button><div class="forgotIcon">◇</div><span>KHÔI PHỤC TÀI KHOẢN</span><h2 id="forgotTitle">Quên mật khẩu?</h2><p id="forgotDesc">Nhập email đã đăng ký, chúng tôi sẽ gửi link đặt lại mật khẩu.</p><input type="hidden" id="forgotToken" value=""><label id="forgotEmailField">Email tài khoản<input id="forgotEmail" type="email" autocomplete="username" placeholder="hocvien@email.com"></label><div id="forgotPasswordFields" hidden><label>Mật khẩu mới<div class="passwordField"><input id="forgotNewPassword" type="password" minlength="6" placeholder="Tối thiểu 6 ký tự"><button type="button" id="showForgotPassword" class="showPasswordButton">◎</button></div></label><label>Xác nhận mật khẩu<input id="forgotConfirmPassword" type="password" minlength="6" placeholder="Nhập lại mật khẩu"></label></div><button class="primary" type="submit" id="forgotSubmitBtn">Gửi link đặt lại mật khẩu</button><small>Link đặt lại mật khẩu có hiệu lực trong 30 phút.</small></form>';document.body.appendChild(modal);
function applyForgotMode(){const hasToken=!!document.querySelector('#forgotToken').value;document.querySelector('#forgotEmailField').hidden=hasToken;document.querySelector('#forgotPasswordFields').hidden=!hasToken;document.querySelector('#forgotTitle').textContent=hasToken?'Đặt mật khẩu mới':'Quên mật khẩu?';document.querySelector('#forgotDesc').textContent=hasToken?'Nhập mật khẩu mới cho tài khoản của bạn.':'Nhập email đã đăng ký, chúng tôi sẽ gửi link đặt lại mật khẩu.';document.querySelector('#forgotSubmitBtn').textContent=hasToken?'✓ Cập nhật mật khẩu':'Gửi link đặt lại mật khẩu';document.querySelector('#forgotNewPassword').required=hasToken;document.querySelector('#forgotConfirmPassword').required=hasToken;document.querySelector('#forgotEmail').required=!hasToken}
const resetToken=new URLSearchParams(location.search).get('reset');
if(resetToken){document.querySelector('#forgotToken').value=resetToken;applyForgotMode();modal.classList.add('open');document.body.style.overflow='hidden';history.replaceState(null,'',location.pathname)}else{applyForgotMode()}
